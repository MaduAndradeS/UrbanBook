...
exports.criarCliente = async (req, res) => {
  try {
    const { nome, cpf, data_nasc, email, senha, rua, bairro, cidade, estado, cep, telefone } = req.body;
    ...
    if (error.code === 'P2002') return res.status(400).json({ message: 'CPF ou email já cadastrado' });
